...
<Window x:Name="WpfRunspaceTemplate" x:Class="WpfApp1.MainWindow"
        ...
        mc:Ignorable="d"
        Title="WPF Datagrid File Progress ViewModel with hyperlink demo" WindowStartupLocation="CenterScreen" Visibility="Visible" ResizeMode="CanMinimize" Height="500" Width="600">
    <Window.Resources>
